...
class Tests(unittest.TestCase):
    ...
    def test_assert_no_equals(self):
        self.driver.get("https://www.google.com")
        titulo_pagina = self.driver.title #obtenemos el valor del titulo de la pagina
        self.assertNotEqual("Google", titulo_pagina, "el titulo es igual")
        ...
        #si no hay coincidencia nos va a decir ok 
        #si hay concidencia te va a decir los valores encontrados y el mesj de error
